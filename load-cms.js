...
(function () {
  ...
  function applySettings(data) {
    ...
    window.SITE_SETTINGS = {
      ...
      pricing_messaging_overhaul: d.pricing_messaging_overhaul,
      pricing_lead_magnet_additional: d.pricing_lead_magnet_additional,
      pricing_multi_page_expansion_additional: d.pricing_multi_page_expansion_additional,
      pricing_deployment_additional: d.pricing_deployment_additional,
